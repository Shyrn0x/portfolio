  ...
  return (
    <section className="max-w-5xl mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="rounded-3xl bg-white/70 dark:bg-black/60 border border-gray-200 dark:border-gray-800 shadow-2xl p-0 flex flex-col hover:scale-[1.025] hover:shadow-2xl transition-all duration-200 backdrop-blur-md overflow-hidden">
          <img src="/lampu-on.png" alt="Pengendali Lampu Bluetooth" className="w-full h-40 object-cover object-top" />
          <div className="p-7 flex flex-col gap-3">
            <div className="flex items-center gap-2 mb-1">
              <span className="px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs font-bold">Arduino</span>
              <span className="px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs font-bold">Bluetooth</span>
              <span className="px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs font-bold">Android</span>
              <span className="px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 text-xs font-bold">IoT</span>
            </div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Pengendali Lampu Bluetooth</h2>
            <p className="text-gray-600 dark:text-gray-300">Sistem pengendali lampu menggunakan smartphone via Bluetooth dengan Arduino.</p>
            <div className="flex gap-2 mt-2">
              <a href="/projects/bluetooth-light" className="inline-block px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold shadow hover:scale-105 hover:from-blue-700 hover:to-cyan-600 transition-all text-sm">Lihat detail</a>
            </div>
          </div>
        </div>
